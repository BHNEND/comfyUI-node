...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "Qwen3TTSVoiceClone": "Qwen3 TTS 语音克隆",
    "Qwen3TTSCreateVoicePrompt": "Qwen3 TTS 创建角色预设",
    "Qwen3TTSVoiceCloneWithPrompt": "Qwen3 TTS 角色预设克隆",
    "Qwen3TTSCustomVoice": "Qwen3 TTS 预设音色",
